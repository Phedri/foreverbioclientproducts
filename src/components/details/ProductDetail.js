            ...
            <div class="row">
              <div class="col-lg-10 col-md-12 col-lg-offset-1">
                ...
                <div class="ps-product__info">
                  ...
                  <h1>NOM</h1>
                  <p class="ps-product__category">CATÉGORIE</p>
                  ...
                  <div class="ps-product__block ps-product__size">
                    <h4>
                      CHOISIR LA QUANTITÉ<a href="#">max quantité: 50</a>
                    </h4>
                    <div class="container">
                      <button
                        class="ps-btn ps-btn--gray"
                        data-decrease
                        style={{ padding: "10px 15px", marginRight: "3px" }}
                      >
                        -
                      </button>
                      <input
                      ...
                      <button
                        class="ps-btn ps-btn--gray"
                        style={{ padding: "10px 15px", marginLeft: "3px" }}
                        data-increase
                      >
                        +
                      </button>
                ...
                <div class="tab-content mb-60">
                  <div class="tab-pane active" role="tabpanel" id="tab_01">
                    <p>
                      ...
                      jelly bear claw liquorice. Gingerbread lollipop dragée
                      cake. Pie topping jelly-o. Fruitcake dragée candy canes
                      tootsie roll. Pastry jelly-o cupcake. Bonbon brownie
                      soufflé muffin.
                    </p>
                    <p>
                      ...
                      cake cake bear claw jujubes topping cake apple pie.
                      Jujubes gummi bears soufflé candy canes topping gummi
                      bears cake soufflé cake. Cotton candy soufflé sugar plum
                      pastry sweet roll..
                    </p>
                  </div>
